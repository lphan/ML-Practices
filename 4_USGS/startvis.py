...
class StartVis(StartML):
    ...
    def vis_basemap(cls, data):
        ...
        earth = Basemap(projection='mill', llcrnrlat=-80, urcrnrlat=80, llcrnrlon=-180, urcrnrlon=180, lat_ts=20,
                        resolution='c')
        ...
        if mag:
            ...
            earth.plot(x, y, "x", markersize=2, color='red')
